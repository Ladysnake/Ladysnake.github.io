...
*(All screenshots with a bloom effect were taken with [Canvas Renderer](https://www.curseforge.com/minecraft/mc-mods/canvas-renderer) and [Lumi Lights](https://spiralhalo.github.io/)*
...
![Ghostly Aura](illuminations/GhostlyAura.gif){: .wiki}
...
![Dissolution Wisp Pet](illuminations/DissolutionWispPet.gif){: .wiki}
